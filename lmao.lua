...
-- ===== ALL GAMES ARE NOW KEYLESS =====
local GameList = {
	["9584852943"] = { id = "61e0f394c005902cda5643069ac59226", keyless = true },
	["7326934954"] = { id = "00e140acb477c5ecde501c1d448df6f9", keyless = true },
	["10148749921"] = { id = "0d120852a6e2eb65c691e5ce2c628429", keyless = true },
	...
	["10563114921"] = { id = "82f55d768183c258359d9a7c093d5a60", keyless = true },
}
-- ===================================
...
-- --------------------------------------------------------------------
--  The rest of the UI code is untouched – it will never run because
--  IsKeyless is always true, but it remains here exactly as original.
-- --------------------------------------------------------------------
do
